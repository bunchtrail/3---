...
def multiply_matrices_with_power(A, B, power):
    """
...
def main():
    ...
    if choice.strip() == '+':
        ...
        subprocess.run(["python", "merged.py"])
    else:
...
def main_2_1task():
    ...
    print("=" * 50)
    P2 = multiply_matrices_with_power(P, P, 2)
    ...
    print("=" * 50)
    P3 = multiply_matrices_with_power(P2, P, 3)
...
if __name__ == "__main__":
    main()
    # Uncomment the following line to run 2.1task functionalities
    main_2_1task()